...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"unirequestone","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 5 */
/*!*******************************************************************!*\
  !*** /Users/admin/Desktop/uniappproject/unirequestone/pages.json ***!
  \*******************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 12 */
/*!***********************************************************************!*\
  !*** /Users/admin/Desktop/uniappproject/unirequestone/common/http.js ***!
  \***********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var baseUrl = "https://api.uchat.com.cn";
var sessionKey = "sessionKey";

//网络判断
var hasNetwork = function hasNetwork() {
  var result = true;
  uni.getNetworkType({
...
//登录请求+注册请求+忘记密码
var sendLoginOrRegisterRequest = function sendLoginOrRegisterRequest(param) {
...
//封装除登录外的业务网络请求
var sendRequest = function sendRequest(param) {
  if (!hasNetwork()) {//移到页面中判断：适配按钮状态变化的逻辑
    return;
  }
  var _self = this,
...
//上传文件
var uploadFileRequest = function uploadFileRequest(param) {
  if (!hasNetwork()) {//移到页面中判断：适配按钮状态变化的逻辑
    return;
  }
  var _self = this,
...

{
  ...
  sendLoginOrRegisterRequest: sendLoginOrRegisterRequest,
  sendRequest: sendRequest,
  uploadFileRequest: uploadFileRequest,
  HttpRequest: HttpRequest,
  getSession: getSession,
  setSession: setSession,
  clearSession: clearSession };exports.default = _default;
